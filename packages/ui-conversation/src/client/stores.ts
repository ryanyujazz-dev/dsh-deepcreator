...
type ChatActions = {
  ...
  setRenderMode: (draft: ChatStoreState, mode: string) => void
}
...
export function createChatStore(): EngineStoreHandle<ChatStoreState, ChatActions> {
  return defineStore({
    ...
    init: (): ChatStoreState => ({ selection: null, draft: '', view: null, inspect: null, renderMode: null }),
    ...
    actions: {
      ...
      setRenderMode: (d, mode: string) => { d.renderMode = mode },
    },
  })
}
