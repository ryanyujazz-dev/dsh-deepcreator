/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-theme`.
 * @module @ryanyujazz/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-theme'
