/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-agent-preset`.
 * @module @ryanyujazz/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-agent-preset'
