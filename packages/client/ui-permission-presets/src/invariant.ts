/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-permission-presets`.
 * @module @ryanyujazz/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-permission-presets'
