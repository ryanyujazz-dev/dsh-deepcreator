...
export const zh = {
  ...
  'review.scope.choose': '选择审查范围', 'review.scope.unstaged': '未暂存', 'review.scope.staged': '已暂存', 'review.scope.uncommitted': '未提交', 'review.scope.history': '历史轮次', 'review.scope.turn': '第 {turn} 轮',
...
export const en: Record<ToolsKey, string> = {
  ...
  'review.scope.choose':'Choose review scope','review.scope.unstaged':'Unstaged','review.scope.staged':'Staged','review.scope.uncommitted':'Uncommitted','review.scope.history':'Historical turns','review.scope.turn':'TURN {turn}',
