...
export const zh = {
  ...
  'review.summaryWarning': '变更统计暂不可用', 'review.patchUnavailable': 'Diff 内容暂不可用，请刷新后重试。', 'review.repository.breadcrumb': '仓库位置', 'review.repository.root': '工作区',
...
export const en: Record<ToolsKey, string> = {
  ...
  'review.summaryWarning':'Change statistics unavailable','review.patchUnavailable':'Diff content is unavailable. Refresh to retry.','review.repository.breadcrumb':'Repository location','review.repository.root':'Workspace','review.presentation.text':'Text file changed','review.presentation.binary':'Binary file changed','review.presentation.rename':'File renamed','review.presentation.mode':'File mode changed','review.presentation.empty':'Empty file changed','review.presentation.repository':'Nested repository; open to review','review.presentation.submodule':'Git submodule; open to review','review.presentation.unknown':'This file contains a non-text change',
