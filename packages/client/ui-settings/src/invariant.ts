/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-settings`.
 * @module @ryanyujazz/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-settings'
