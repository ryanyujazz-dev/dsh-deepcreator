...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * One feature-owned preference row inside the shared Preferences group.
     * The group supplies spacing, separators, and responsive row placement;
     * registrants own their copy, durable field, live state, and write path.
     * Options: `id` (row key) and `order` (row position).
     */
