...
// ONE register() call declares the frame child slots + seats the store factory
...
import { apply as nodeApply } from '@ryanyujazz/dsh-client-ui-layout'
import * as invariant from '@ryanyujazz/dsh-client-ui-layout/invariant'
...
describe('ui-layout client apply', () => {
  ...
  it('teardown unwinds the service, the root registration, and the child declarations', async () => {
    ...
    expect(slots.spec('deepcreator.shell.sidebar-toggle')).toBeUndefined()
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@ryanyujazz/dsh-client-ui-layout', expect.any(Function))
