/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-layout`.
 * @module @ryanyujazz/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-layout'
