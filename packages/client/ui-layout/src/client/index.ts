 ...
 * ctx.layout is the cross-plugin panel-action contract; navigation state
 * lives with the runtime sessions service. A second effect seats the theme
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => {
    ...
    const disposeRegistration = ctx.slots.register({
      ...
      // framework delivers useStore/actions to AppFrame as standard props.
      store: layoutStore,
