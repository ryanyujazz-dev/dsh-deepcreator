/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-settings-general`.
 * @module @ryanyujazz/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-settings-general'
