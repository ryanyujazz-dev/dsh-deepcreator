/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-user-questions`.
 * @module @ryanyujazz/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-user-questions'
