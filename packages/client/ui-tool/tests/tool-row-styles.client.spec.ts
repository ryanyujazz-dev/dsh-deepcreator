...
describe('execution-flow guide rails', () => {
  it('renders result images in a half-width strip below the summary, aligned to the 22px title column in execution flow', () => {
    expect(declarations('.media')).toEqual(expect.arrayContaining(['margin: 4px 0 4px 4px', 'width: 50%']))
