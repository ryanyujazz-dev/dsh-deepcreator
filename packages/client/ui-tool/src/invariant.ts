/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-tool`.
 * @module @ryanyujazz/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-tool'
