/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-subagent`.
 * @module @ryanyujazz/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-subagent'
