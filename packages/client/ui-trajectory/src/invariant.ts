/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-trajectory`.
 * @module @ryanyujazz/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-trajectory'
