...
} from '@ryanyujazz/dsh-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@ryanyujazz/dsh-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@ryanyujazz/dsh-client-ui-conversation/src/client/locales.ts'
...
import { apply, inject } from '@ryanyujazz/dsh-client-ui-trajectory/client'
import { apply as nodeApply } from '@ryanyujazz/dsh-client-ui-trajectory'
...
function standaloneDuration(): Pick<
  ComponentProps<typeof TrajectoryView>, 'useDuration'
> {
...
describe('plugin registration', () => {
  it('registers trajectory after chat on the ring', async () => {
    ...
    expect(b.slots.entries('conversation.session.header.utilities')).toEqual([])
  })
...
describe('TrajectoryView state', () => {
  it('persists the duration preference through the runtime snapshot-store seam', () => {
    ...
    expect(firstDuration.getSnapshot()).toBe(false)
    firstDuration.set(true)
