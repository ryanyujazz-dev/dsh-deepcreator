/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-workspace`.
 * @module @ryanyujazz/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-workspace'
