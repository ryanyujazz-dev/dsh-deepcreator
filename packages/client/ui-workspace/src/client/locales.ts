...
export const zh = {
  ...
  'deleteSession.desc': '将永久删除“{name}”的会话日志与附件，且无法恢复。',
  'deleteSession.acknowledge': '我了解此操作无法撤销',
...
export const en = {
  ...
  'deleteSession.desc': 'This permanently deletes the session log and attachments of “{name}”. It cannot be undone.',
  'deleteSession.acknowledge': 'I understand this cannot be undone',
