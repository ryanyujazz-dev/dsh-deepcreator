...
const workspaceState = (items: readonly WorkspaceView[], archivedSessionIds: readonly SessionId[] = []): WorkspaceSnapshot => ({
...
describe('WorkspaceBrowser', () => {
  it('uses one glyph size for every sidebar header action in both interaction states', () => {
    mount()
    const glyphWidth = (name: string): string | null => screen
