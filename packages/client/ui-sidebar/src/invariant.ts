/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-sidebar`.
 * @module @ryanyujazz/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-sidebar'
