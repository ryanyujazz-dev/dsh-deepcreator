/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-model-selection`.
 * @module @ryanyujazz/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-model-selection'
