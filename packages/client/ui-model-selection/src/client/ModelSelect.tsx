...
export function ModelSelect(
  ...
  // Official parity: while the catalog is still loading with no current
  // model, the trigger (visible and aria) names the load instead of a
  // fallback that implies a choice exists.
