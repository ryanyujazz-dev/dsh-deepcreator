...
// Type-only fork entry: the official `chat` map key arrives through the
// official ui-chat package's module augmentation of the npm /client face,
// which cannot reach this vendored copy of the contract. The fork ships its
// own chat view builder, so it owns the key typing here too.
