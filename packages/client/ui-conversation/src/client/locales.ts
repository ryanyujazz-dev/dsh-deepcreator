...
export const zh = {
  ...
  'execflow.agg.tools': '执行 {count} 次工具',
  'execflow.agg.tools.one': '执行 1 次工具',
  ...
  'settings.renderMode.title': '默认渲染模式',
  'settings.renderMode.description': '会话没有单独选择时使用的对话流样式。',
  'settings.renderMode.normal': '原生',
  'settings.renderMode.classic': '经典',
  'settings.renderMode.think': '思考',
  ...
  'bash.failed': '失败',
  'bash.stopped': '已停止',
  'row.revealChange': '在审查面板查看该文件的变更',
  'row.running': '运行中',
  'row.failed': '失败',
  'row.stopped': '已停止',
  'queue.count': '{n} 条排队消息',
...
export const en = {
  ...
  'settings.renderMode.title': 'Default render mode',
  'settings.renderMode.description': 'Conversation-flow style used when a session has no individual selection.',
  'settings.renderMode.normal': 'Native',
  'settings.renderMode.classic': 'Classic',
  'settings.renderMode.think': 'Think',
  ...
  'row.revealChange': 'Show this file change in Review',
  'row.running': 'Running',
  'row.failed': 'Failed',
  'row.stopped': 'Stopped',
