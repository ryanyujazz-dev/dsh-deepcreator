...
/** Slash commands and skills are facts only at whitespace/end boundaries;
 * paths and prose such as `/plan.md` or `/plan。` stay ordinary text. */
 ...
 * exact lexicon member; `/name` must end at whitespace or the draft end.
