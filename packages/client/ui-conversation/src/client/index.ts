...
export type {
  ...
  ConversationHeaderCornerOwnerProps, ConversationHeaderUtilityOwnerProps,
  ConversationSessionHeaderInjected, ConversationSessionInjected,
