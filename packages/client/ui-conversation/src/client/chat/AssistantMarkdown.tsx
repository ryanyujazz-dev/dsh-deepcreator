...
export interface AssistantMarkdownProps {
  ...
  /** Slot-backed durable image renderer. */
...
export const AssistantMarkdown = memo(function AssistantMarkdown({
  blocks, streaming, interrupted, renderMessageImages = () => null, mentions, thinkExpanded, t,
  ...
  for (let i = 0; i < blocks.length; i++) {
    ...
    switch (block.kind) {
      ...
      case 'image': {
        ...
        rendered.push(<span key={start}>{renderMessageImages({ images: group, align: 'start' })}</span>)
        break
      }
