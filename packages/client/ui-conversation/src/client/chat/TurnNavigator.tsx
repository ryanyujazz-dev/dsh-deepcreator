...
/** The rail's locale seat: the fork's conversation translate carrying the four turnNavigation keys. */
export type TurnNavigatorTranslate = ForkTranslate
...
interface TurnNavigatorProps {
  ...
  readonly t: TurnNavigatorTranslate
}
