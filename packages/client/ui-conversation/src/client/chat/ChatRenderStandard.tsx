// ChatRenderStandard: the shipped `normal` render mode of the chat view —
// the stock flow: one stable keyed parent list over final business Nodes,
// plus paging, pending steering and bottom-follow. Rendered by ChatView
// through the 'conversation.chat.render' ring; the node render seat is
// delegated from the chat entry (owner props), so this entry declares no
// children of its own.
//
...
/**
 * The `normal` chat render-mode body: pure component over the composed
 * props; each ordered business Node crosses the chat entry's delegated
 * keyed renderer seat.
 */
