...
/** Compact token count with locale-owned suffixes. */
export function formatTokens(value: number, t: ForkTranslate): string {
...
export function formatExactTokens(value: number, t: ForkTranslate): string {
...
/** Display a cache ratio without rounding a partial hit up to 100%. */
