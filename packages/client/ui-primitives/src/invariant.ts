/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-ui-primitives`.
 * @module @ryanyujazz/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-ui-primitives'
