...
/** Workbench Artifact: a page with a folded corner and two text lines. */
export const DeepCreatorIconArtifact16 = (props: IconProps) => (
  <WorkbenchGlyph {...props} name="workbench-artifact">
    <path fill="currentColor" d="M4.14 0.67Q3.57 0.67 3.07 0.97Q2.58 1.26 2.28 1.76Q1.98 2.26 1.98 2.83L1.98 13.17Q1.98 13.76 2.28 14.26Q2.58 14.75 3.07 15.04Q3.57 15.33 4.14 15.33L11.84 15.33Q12.43 15.33 12.93 15.04Q13.42 14.75 13.72 14.26Q14.02 13.76 14.02 13.17L14.02 4.83L9.84 0.67L4.14 0.67ZM10.32 4.83Q10.11 4.83 9.97 4.68Q9.82 4.53 9.82 4.32L9.82 2.06L12.59 4.83L10.32 4.83ZM4.14 14.34Q3.66 14.34 3.32 13.99Q2.98 13.65 2.98 13.17L2.98 2.83Q2.98 2.35 3.32 2.01Q3.66 1.66 4.14 1.66L8.82 1.66L8.82 4.32Q8.82 4.74 9.02 5.08Q9.22 5.42 9.56 5.62Q9.9 5.82 10.32 5.82L13.01 5.82L13.01 13.17Q13.01 13.65 12.66 13.99Q12.32 14.34 11.84 14.34L4.14 14.34ZM7.68 8Q7.89 8 8.04 7.86Q8.19 7.71 8.19 7.5Q8.19 7.3 8.04 7.14Q7.89 6.99 7.68 6.99L5.01 6.99Q4.82 6.99 4.66 7.14Q4.51 7.3 4.51 7.5Q4.51 7.71 4.66 7.86Q4.82 8 5.01 8L7.68 8ZM5.01 9.84Q4.82 9.84 4.66 9.98Q4.51 10.13 4.51 10.34Q4.51 10.54 4.66 10.69Q4.82 10.83 5.01 10.83L10.99 10.83Q11.2 10.83 11.34 10.69Q11.49 10.54 11.49 10.34Q11.49 10.13 11.34 9.98Q11.2 9.84 10.99 9.84L5.01 9.84Z" />
  </WorkbenchGlyph>
)
