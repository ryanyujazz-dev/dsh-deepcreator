/**
 * Package-owned invariant companion for `@ryanyujazz/dsh-client-locale`.
 * @module @ryanyujazz/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@ryanyujazz/dsh-client-locale'
