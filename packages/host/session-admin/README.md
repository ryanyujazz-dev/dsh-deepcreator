...
by the raw id), recognizes canonical immutable generations such as
`session.v3.jsonl` and their `.zstd` encodings, refuses ambiguous matches across workspaces, refuses live
