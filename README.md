...
<p align="center">
  <code>DeepSeek Harness 0.1.5-alpha.1</code> · <code>Development runtime</code> · <code>#dsh-plugin</code>
</p>
...
```sh
pnpm --filter @ryanyujazz/dsh-deepcreator-desktop exec dsh plugin --profile deepcreator add @deepseek-ai/dsh-mcp-client@0.1.5-alpha.1
...
The compatibility declaration targets DeepSeek Harness `0.1.5-alpha.1` at Git SHA `5dda764ed3aa172535a7967b06ff95d9cbfe536a`.
