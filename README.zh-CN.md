...
<p align="center">
  <code>DeepSeek Harness 0.1.5-alpha.1</code> · <code>开发运行时</code> · <code>#dsh-plugin</code>
</p>
...
当前兼容声明面向 DeepSeek Harness `0.1.5-alpha.1`，Git SHA 为 `5dda764ed3aa172535a7967b06ff95d9cbfe536a`。
